...
export const PEOPLE: Person[] = [
  {
    ...
    email: "maya.hollis@pacsun.example",
    level: 1,
    managerId: null,
    function: "executive",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "grace.whitfield@pacsun.example",
    level: 3,
    managerId: "p_ceo",
    function: "executive",
  ...
  },
  {
    ...
    email: "ray.alvarez@pacsun.example",
    level: 2,
    managerId: "p_ceo",
    function: "operations",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "priya.raman@pacsun.example",
    level: 2,
    managerId: "p_ceo",
    function: "finance",
  ...
  },
  {
    ...
    email: "dana.okonkwo@pacsun.example",
    level: 2,
    managerId: "p_ceo",
    function: "technology",
  ...
  },
  {
    ...
    email: "tomas.lund@pacsun.example",
    level: 2,
    managerId: "p_ceo",
    function: "marketing",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "marcus.field@pacsun.example",
    level: 2,
    managerId: "p_ceo",
    function: "legal",
    roles: ["executive", "reviewer"],
  ...
  },
  {
    ...
    email: "nina.serrano@pacsun.example",
    level: 3,
    managerId: "p_coo",
    function: "operations",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "jordan.pike@pacsun.example",
    level: 3,
    managerId: "p_coo",
    function: "logistics",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "sam.rivera@pacsun.example",
    level: 3,
    managerId: "p_cmo",
    function: "marketing",
    roles: ["executive"],
  ...
  },
  {
    ...
    email: "ellie.novak@pacsun.example",
    level: 5,
  ...
  },
  {
    ...
    email: "lena.marsh@pacsun.example",
    level: 3,
    managerId: "p_cfo",
    function: "finance",
    roles: ["auditor"],
